...
class DataCustomLanguageDatasetConfig:
    ...
    save_detokenized_text_path:str = "detokenized_text_2.json"
    save_tokenizer_vocabulary_path:str = "tokenizer_vocabulary_2.json"
...
class DataCustomLanguageDataset(TorchDataset):
    def __init__(self, data_config: DataCustomLanguageDatasetConfig):
        ...
        self.dataset = Dataset.from_dict({"text": self.prompts})
